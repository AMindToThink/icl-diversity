...
The $a_k$ framework provides a text-level alternative: collapse should appear as a drop in $a_n$ on the agent's own outputs, independent of reward structure.
