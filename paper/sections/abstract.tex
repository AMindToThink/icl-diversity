...
We summarize this curve via two complementary quantities: the \emph{surprise floor} $a_n$ (the residual per-byte surprise after the base model has learned what it can from the other responses) and a separate \emph{coherence} term $C$ (how plausible the outputs are per byte).
