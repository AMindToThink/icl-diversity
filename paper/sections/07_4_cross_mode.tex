...
Extending to the full $a_k$ curve at $m>1$ requires modeling information overlap across repeated encounters, a structure that pairwise (single-encounter) measurements do not capture.
