...
\paragraph{Headline result.} On the binary tasks $D_{Ca_n}$ matches the strongest embedding baseline.
...
Each set has 5 responses, well below the $\sim$20 needed for the excess-entropy alternative $E$ (Appendix~\ref{app:excess-entropy}) to converge.
