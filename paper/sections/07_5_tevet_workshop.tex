...
That $a_n$ tracks temperature is mechanically unsurprising: $a_n$ is a conditional-entropy quantity, and sampling temperature directly scales the entropy of the policy, so a positive $\rho$ here is a sanity check rather than evidence about creative diversity.}
\label{tab:dectest}
\small
